...
Marpa::R3::HTML - High-level HTML Parser
...
L<Marpa::R3::HTML> recognizes elements even if they have missing
start and/or end tags.
L<Marpa::R3::HTML> can B<supply missing tags>:
...
perltidy: '-dcsc -sil=0'
    ...
    sub supply_missing_tags {
        ...
        return ( Marpa::R3::HTML::start_tag() // "<$tagname>\n" )
...
L<Marpa::R3::HTML> understands the hierarchical structure of an HTML document.
...
L<Marpa::R3::HTML> tracks actual elements, however tagged.
The above code returns the same depth for C<$valid_html_with_all_tags>
as for C<$html_with_just_a_title>.

=head1 DESCRIPTION

L<Marpa::R3::HTML> does "high-level" parsing of HTML.
...
L<Marpa::R3::HTML> is an extremely liberal HTML parser.
L<Marpa::R3::HTML> does not reject any documents,
no mater how poorly they fit the HTML standards.

=head1 THE Marpa::R3::HTML::html STATIC METHOD

The interface to
L<Marpa::R3::HTML> is through the
C<Marpa::R3::HTML::html>
static method.
It is
the only
L<Marpa::R3::HTML>
...
Handler descriptions in L<Marpa::R3::HTML> are key-value pairs
in a hash.
...
L<Marpa::R3::HTML> are case-sensitive, and must be all uppercase.
...
L<Marpa::R3::HTML> reclasses as cruft.

L<Marpa::R3::HTML> reclasses terminals as cruft when
they do not fit the structure of an HTML document.
One example of a terminal that
L<Marpa::R3::HTML> would reclass as cruft is a
...
L<Marpa::R3::HTML> leaves interpretation of markup and entities entirely to
the application.
...
Cruft can also be found here, though for L<Marpa::R3::HTML> that is a
last resort.

=head2 :WHITESPACE

A L<Marpa::R3::HTML> C<:WHITESPACE> terminal is created for every
...
that the action semantics of L<Marpa::R3::HTML> are natural.
...
through the L</"Marpa::R3::HTML::original"> API method.
...
The original view is seen
through the L</"Marpa::R3::HTML::values"> API method.
...
The descendants view is implemented via the L</"Marpa::R3::HTML::descendants"> method.
...
In terms of L<Marpa::R3::HTML> views,
...
For L<Marpa::R3::HTML> this is close to the worst case.

L<Marpa::R3::HTML> optimizes for unvalued components.
...
L<Marpa::R3::HTML>'s semantic action API is implemented
...
=item Marpa::R3::HTML::descendants
...
=item Marpa::R3::HTML::is_empty_element
...
The C<Marpa::R3::HTML::offset> method return C<undef>
for these.

=item Marpa::R3::HTML::original

The C<Marpa::R3::HTML::original> method implements the original view.
Returns a string containing the original view of the component --
its text unchanged from the source document.

=item Marpa::R3::HTML::start_tag
...
=item Marpa::R3::HTML::values

The C<Marpa::R3::HTML::values> method implements the values view.
...
The C<Marpa::R3::HTML::descendants> method takes a dataspec
as its argument.
The C<Marpa::R3::HTML::descendants> method returns a reference
...
L</"Marpa::R3::HTML::token_type"> API method.
...
Each L<Marpa::R3::HTML> instance
makes available
a per-instance variable
as a scratchpad for the application:
C<$Marpa::R3::HTML::INSTANCE>.
Each call to
L<Marpa::R3::HTML::html|/"THE Marpa::R3::HTML::html STATIC METHOD">
creates a C<$Marpa::R3::HTML::INSTANCE>
variable which is
...
C<$Marpa::R3::HTML::INSTANCE> can be used to
store the data.

Ordinarily, C<$Marpa::R3::HTML::INSTANCE> is destroyed,
with the rest of the parse instance,
when C<Marpa::R3::HTML::html> returns.
But it can be useful
for the C<:TOP> semantic action to
return
C<$Marpa::R3::HTML::INSTANCE> as the value of the parse.
...
under which
L<Marpa::R3::HTML> will recognize a virtual end tag.
At end of file,
as one example,
L<Marpa::R3::HTML> will do its best to produce a balanced
HTML structure by
...
L<Marpa::R3::HTML> exports nothing by default.
Optionally,
L<Marpa::R3::HTML::html|/"THE Marpa::R3::HTML::html STATIC METHOD">
may be exported.
