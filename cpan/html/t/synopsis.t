...
my %handlers_to_keep_only_tables = (
    table  => sub { return Marpa::R3::HTML::original() },
    ':TOP' => sub { return \( join q{}, @{ Marpa::R3::HTML::values() } ) }
);
...
sub depth_below_me {
    return List::Util::max( 0, @{ Marpa::R3::HTML::values() } );
}
...
my $maximum_depth_with_all_tags_supplied = html( $valid_html_with_all_tags,
    \%handlers_to_calculate_maximum_element_depth );
Marpa::R3::Test::is( $maximum_depth_with_just_a_title,
...
Marpa::R3::Test::is( ${$no_table}, 'Text More Text', 'delete tables' );
Marpa::R3::Test::is(
    ${$only_table},
...
Marpa::R3::Test::is( ${$edited_stuff}, '<p>A<p>C', 'delete by class name' );
Marpa::R3::Test::is(
