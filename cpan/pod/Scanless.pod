...
Marpa::R3::Scanless - Scanless interface

=head1 About this document

This document is intended for readers already familiar with
Marpa::R3's BNF (Stuifzand) interface.
...
L<one dealing with scanless grammar objects|Marpa::R3::Scanless::G>
and
L<one dealing with scanless recognizer objects|Marpa::R3::Scanless::R>.
...
described using Marpa::R3's scanless interface:
...
ordinary grammars|Marpa::R3::Semantics>.
