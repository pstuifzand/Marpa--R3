...
=head1 THIS IS BETA SOFTWARE

Marpa::R2 is beta software.
...
L<C<Marpa::R3::Recognizer>|Marpa::R3::Recognizer> objects.
...
They are created
with the
L<Marpa::R3::Grammar::new|Marpa::R3::Grammar/"new">
constructor.
The arguments to
L<Marpa::R3::Grammar::new|Marpa::R3::Grammar/"new">
are references to
...
=head2 Marpa::R3::Grammar::precompute
...
The C<Marpa::R3::Recognizer::read> method takes two arguments,
...
The first thing C<Marpa::R3::Recognizer::value> needs to do is
...
the C<Marpa::R3::Recognizer::value> method iterates through the parse results.
For each call,
it returns a reference to the parse result.
At the end of the iteration, after
all parse results have been returned,
C<Marpa::R3::Recognizer::value> returns C<undef>.
If there were no parse results,
C<Marpa::R3::Recognizer::value> returns C<undef> the first
