...
For details, see L<Marpa::R3::Grammar/"action_object">.

=head2 default_action

Specifies the C<default_action> named argument that
will be used for the G1 grammar.
For details, see L<Marpa::R3::Grammar/"default_action">.
...
calling L<Marpa::R3::Grammar's show_rules()
method|Marpa::R3::Grammar/"show_rules()">
...
L<that of
BNF source strings|Marpa::R3::BNF>,
