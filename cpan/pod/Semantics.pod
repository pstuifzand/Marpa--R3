...
Marpa::R3::Semantics - How Marpa evaluates parses
...
and
L<C<reset_evaluation>|Marpa::R3::Recognizer/"reset_evaluation">
methods.
...
Some rules are L<sequence rules|Marpa::R3::Grammar/"Sequence Rules">.
...
null semantics|Marpa::R3::Semantics::Null>.
...
L<the grammar's C<rule()> method|Marpa::R3::Grammar/"rule">.

=item * C<Marpa::R3::Context::location()> returns the start
...
method|Marpa::R3::Recognizer/"reset_evaluation">
...
L<A separate
document|Marpa::R3::Semantics::Phases>
...
document|Marpa::R3::Semantics::Infinite>.
