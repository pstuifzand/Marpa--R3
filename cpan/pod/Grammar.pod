...
Marpa::R3::Grammar - Marpa grammars
...
document|Marpa::R3::Semantics/"Sequence Rule Nodes">.
...
callbacks and
use of L<the progress method|Marpa::R3::Progress/progress()>.
...
Details are in
L<the document on semantics|Marpa::R3::Semantics>.
...
L<the document on the BNF format|Marpa::R3::BNF>.
