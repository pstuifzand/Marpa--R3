...
Marpa::R3::Vocabulary - Standard parsing terms as used within Marpa
...
excellent chapter on parsing in the Perl context|Marpa::R3::Advanced::Bibliography/"Dominus 2005">.
It's available on-line.
L<Wikipedia|Marpa::R3::Advanced::Bibliography/"Wikipedia"> is also an excellent place to start.
