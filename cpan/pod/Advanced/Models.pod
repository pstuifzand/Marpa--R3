...
Marpa::R3::Advanced::Models - Other input models
...
the recognizer|Marpa::R3::Recognizer> on the assumption
...
as described for
the L<recognizer's C<read> method|Marpa::R3::Recognizer/"read()">.
...
calls to
its L<C<read>|Marpa::R3::Recognizer/"read()">
